...
import { X, PanelLeft, LayoutDashboard, Wrench, Boxes, Gauge, History, ClipboardCheck, Building2, Car, ShieldCheck, Trash2, HardHat, ChevronRight, Check, Circle, Moon, Sun, LogOut } from "lucide-react";
import { c as cn } from "./utils-H80jjgLf.js";
import { B as Button, I as Input } from "./button-DvaFYl8e.js";
import * as SeparatorPrimitive from "@radix-ui/react-separator";
import * as SheetPrimitive from "@radix-ui/react-dialog";
import * as TooltipPrimitive from "@radix-ui/react-tooltip";
import { u as useTheme, a as useAuth } from "./router-CDNe7lBx.js";
...
function AppSidebar() {
  ...
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { className: "border-b border-sidebar-border px-4 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-md bg-sidebar-primary text-sidebar-primary-foreground font-bold", children: "PM" }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col leading-tight group-data-[collapsible=icon]:hidden", children: [
        /* @__PURE__ */ jsx("span", { className: "text-sm font-semibold text-sidebar-foreground", children: "PM Studio" }),
        /* @__PURE__ */ jsx("span", { className: "text-[10px] uppercase tracking-wider text-sidebar-foreground/70", children: "FMS · GA · K3L" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx(SidebarContent, { children: groups.map((g) => /* @__PURE__ */ jsxs(SidebarGroup, { children: [
      /* @__PURE__ */ jsx(SidebarGroupLabel, { children: g.label }),
      /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: g.items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, isActive: isActive(item.url), tooltip: item.title, children: /* @__PURE__ */ jsxs(Link, { to: item.url, className: "flex items-center gap-2", children: [
...
function AppShell({ children }) {
  ...
  return /* @__PURE__ */ jsx(SidebarProvider, { children: /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen w-full bg-background", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col", children: [
      /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border bg-card/80 px-4 backdrop-blur", children: [
        /* @__PURE__ */ jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsx("div", { className: "flex-1" }),
        /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "icon", onClick: toggle, "aria-label": "Toggle theme", children: theme === "light" ? /* @__PURE__ */ jsx(Moon, { className: "h-4 w-4" }) : /* @__PURE__ */ jsx(Sun, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxs(Button, { variant: "ghost", className: "gap-2 px-2", children: [
            /* @__PURE__ */ jsx(Avatar, { className: "h-7 w-7", children: /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-xs", children: initials }) }),
            /* @__PURE__ */ jsxs("div", { className: "hidden text-left sm:block", children: [
              /* @__PURE__ */ jsx("div", { className: "text-xs font-medium", children: user?.email }),
              /* @__PURE__ */ jsx("div", { className: "text-[10px] text-muted-foreground", children: isAdmin ? "Admin" : roles[0] ?? "Member" })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxs(DropdownMenuContent, { align: "end", className: "w-56", children: [
            /* @__PURE__ */ jsxs(DropdownMenuLabel, { className: "flex items-center justify-between", children: [
              "Akun",
              /* @__PURE__ */ jsx(Badge, { variant: "secondary", className: "text-[10px]", children: isAdmin ? "ADMIN" : "USER" })
            ] }),
      ...
      /* @__PURE__ */ jsx("main", { className: "flex-1 p-6", children })
    ] })
  ] }) });
}
