...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BSqMhWBd.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C69brUar.js").then((n) => n.r),
    import("./start-_j0VdhnW.js"),
...
var ROUTER_BASEPATH = "NAMA_REPOSITORI_ANDA";
var SERVER_FN_BASE = "/NAMA_REPOSITORI_ANDA/_serverFn/";
