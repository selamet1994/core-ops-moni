...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-m2uQTxJP.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Dd6dDKk7.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "core-ops-moni";
var SERVER_FN_BASE = "/core-ops-moni/_serverFn/";
